...
_G.packer_plugins = {
  ...
  tabular = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/tabular",
  ...
  ["vim-dispatch"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/kali/.local/share/nvim/site/pack/packer/opt/vim-dispatch",
    url = "https://github.com/tpope/vim-dispatch"
  },
  ["vim-repeat"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/vim-repeat",
